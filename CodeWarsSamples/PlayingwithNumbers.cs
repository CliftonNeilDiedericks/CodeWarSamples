...
namespace CodeWarsSamples
{
    ...
    */
    public static class PlayingwithNumbers
    {
        public static long digPow(int n, int p)
        {
            ...
            {
                sum += long.Parse(Math.Pow(double.Parse(digit.ToString()), double.Parse(p++.ToString())).ToString());
            }
        ...
        public static long digPow3(int n, int p)
        {
            ...
            {
                var d = char.GetNumericValue(digits[i]);
                sum += (int)Math.Pow(d, p + i);
            }
